...
/* Information about the selected clauses */ //new
int     count_selectCaluse[MAX_CLAUSES];//	amount of clause selected
int     isCandidate_first[MAX_CLAUSES];// Is it a candidate l-level HSCs
int     isCandidate_second[MAX_CLAUSES];// Is it a candidate 2-level HSCs
int     count_candidate_falseClause_first;//Number of l-level HSCs
int     count_candidate_falseClause_second;//Number of 2-level HSCs
int     candidate_falseClause_first_stack[MAX_CLAUSES];//candidate l-level HSCs
int     candidate_falseClause_second_stack[MAX_CLAUSES];//candidate 2-level HSCs
int     whereCandidate_first[MAX_CLAUSES];//the place of candidate l-level HSCs
int     whereCandidate_second[MAX_CLAUSES];//the place of candidate 2-level HSCs
...
int     vSelect[MAX_VARS];//new
int     best_atom[MAX_VARS];//new
//int		pscore[MAX_VARS];
int		fix[MAX_VARS];
...
int fct = 0; //function to use 0= poly 1=exp //new
void (*initLookUpTable)() = NULL;//new
